...
```
cd existing_repo
git remote add origin https://gitlab.com/sylwiajurczyk91/labxstack-webdriverio-task.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/sylwiajurczyk91/labxstack-webdriverio-task/-/settings/integrations)
